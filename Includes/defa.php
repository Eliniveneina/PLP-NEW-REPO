...
function itmfrm()
	...
	echo "<center>";
		...
		echo "Minimum Quantity &nbsp;&nbsp;<input type = 'text' name = 'miniquantity' size='5' required = 'required' /><br /><br />";
...
function itmefrm()
	...
	//Retrieve Item Info
	$query1 = "SELECT itemID, ItemName, Quantity, Unit, Mini_Quantity, BuyingPrice, SellingPrice
	...
	$row1 = mysql_fetch_array($result1);
		...
		$Unit = $row1['Unit'];
		$miniquantity = $row1['Mini_Quantity'];
	...
	echo "<center>";
		...
		echo "Minimum Quantity &nbsp;&nbsp;<input type = 'text' name = 'miniquantity' size='5' value = '$miniquantity' required = 'required' /><br /><br />";
...
// Function Items under minimum list display 
function itmudsp()
	{
	//Table to be used
	$table_name1 = "Items";
	...
	//Retrieve different dates
	$query = "SELECT DISTINCT Date
				FROM $table_name1 WHERE Quantity < Mini_Quantity ORDER BY Date";
	$result = mysql_query($query);
	
	echo "<center>";
	echo "<font size = '5'><b>Items List</b></font>";
	echo "<table id = 'data' width = '98%' border = '1' cellpadding = '1' cellspacing = '0'>";
		echo "<tr><th>No.</th><th>Item Name</th><th>Quantity</th><th>Minimum Quantity</th><th>Buying Price</th><th>Selling Price</th></tr>";
		$no = 1; $c = 1;
	while($row = mysql_fetch_array($result))
			{	if($c % 2 == 0){$bgcolor = "#CCCCCC"; } else{$bgcolor = "#EEEEEE";}
	...
	// Query to retrieve Items' information
 	$query1 = "SELECT itemID, ItemName, Quantity, Unit, Mini_Quantity, BuyingPrice, SellingPrice
 				FROM $table_name1 WHERE Date = '$row[0]' AND Quantity < Mini_Quantity ORDER BY Date";
 	$result1 = mysql_query($query1);
	...
	//Create a loop arround the results.
  	...
  	while($row1 = mysql_fetch_array($result1))
		...
		echo "<tr bgcolor = '$bgcolor'>";
			...
			echo "<td>" . $row1['ItemName'] . "</td>";
			echo "<td align = 'center'>" . $row1['Quantity'] . " " . $row1['Unit'] . "</td>";
			echo "<td align = 'center'>" . $row1['Mini_Quantity'] . "</td>";
			echo "<td align = 'right'>" . $row1['BuyingPrice'] . "&nbsp;</td>";
			echo "<td align = 'right'>" . $row1['SellingPrice'] . "&nbsp;</td>";
		echo "</tr>";
		$no = $no + 1;
...
// The End of Function Items under minimum list display
...
function trsdsp()
	...
	// Query to retrieve Transactions' information
 	$query1 = "SELECT transID, ItemName, T.Quantity, Unit, Price, Verification_Method, Invo_Memo_No, StaffName, DateTime
	...
	echo "<table id = 'data' width = '98%' border = '1' cellpadding = '1' cellspacing = '0'>";
		echo "<tr><th>No.</th><th>Item Name</th><th>Quantity</th><th>Verification Code</th><th>Datetime</th><th>Price</th></tr>";
	//Create a loop arround the results.
		$no = 1;
  	while($row1 = mysql_fetch_array($result1))
   		{
...
function trsfrm()
	...
	echo "<center>";
		...
		echo "<br /><br />";
		echo "<select name = 'verification' title = 'Verification Method'>";
			echo "<option value = ''>Verification</option>";
			echo "<option>Invoice</option>";
			echo "<option>Memo</option>";
		echo "</select>=>";
		echo "<input type = 'text' name = 'invo_memo' size='15' />";
		echo "</fieldset>";
		echo "</td></tr>";
		echo "<tr><td align = 'center'>";
		echo "<fieldset>";
...
function trsedsp()
	...
	echo "<font size = '5'><b>Transactions' Records</b></font>";
	echo "<table id = 'data' width = '98%' border = '1' cellpadding = '1' cellspacing = '0'>";
		echo "<tr><th>No.</th><th>Item Name</th><th>Quantity</th><th>Verification Code</th><th>Datetime</th><th>Price</th><th>Edit</th></tr>";
	//Create a loop arround the results.
		$no = 1;
  	while($row1 = mysql_fetch_array($result1))
   		{
...
function trsefrm()
	...
	// Query to retrieve transaction records
 	$query2 = "SELECT T.itemID, ItemName, SellingPrice, T.Quantity, Price, Verification_Method, Invo_Memo_No, 
	...
	$amount = $row2['Price'];
	$veri = $row2['Verification_Method'];
	$invo_memo = $row2['Invo_Memo_No'];
	$date = $row2['Date'];
	...
	echo "<center>";
		...
		echo "<select name = 'verification' title = 'Verification Method'>";
			if($veri == '')
				...
				{
			echo "<option>$veri</option>";		
				}
			echo "<option value = ''>Verification</option>";
			echo "<option>Invoice</option>";
			echo "<option>Memo</option>";
		echo "</select>=>";
		echo "<input type = 'text' name = 'invo_memo' value = '$invo_memo' size='15' />";
		echo "</fieldset>";
		echo "</td></tr>";
		echo "<tr><td align = 'center'>";
		echo "<fieldset>";
...
function trsddsp()
	...
	// Query to retrieve Transactions' information
 	$query1 = "SELECT transID, ItemName, T.Quantity, Unit, Price, S.staffID, Verification_Method, Invo_Memo_No, 
						StaffName, DateTime
 				FROM $table_name1 T, $table_name2 I, $table_name3 S
				WHERE T.itemID = I.itemID AND T.staffID = S.staffID
				ORDER BY DateTime DESC";
	...
	echo "<font size = '5'><b>Transactions' Records</b></font>";
	echo "<table id = 'data' width = '98%' border = '1' cellpadding = '1' cellspacing = '0'>";
		echo "<tr><th>No.</th><th>Item Name</th><th>Quantity</th><th>Verification Code</th><th>Datetime</th><th>Price</th><th>Drop</th></tr>";
	//Create a loop arround the results.
		$no = 1;
  	while($row1 = mysql_fetch_array($result1))
   		{
