...
function iedrep()
	...
	// Query to retrieve Transactions' information
 	$query1 = "SELECT ItemName, Unit, BuyingPrice, T.Quantity, Price, Verification_Method, Invo_Memo_No, 
						Price - (T.Quantity * BuyingPrice) AS Profit, TIME(DateTime) AS Time
	...
	echo "Filter the Daily Report By Date:<input type='date' name='date' value = '" . date("Y-m-d", time()) . "' required='required'  />
			<input type='submit' value='Search' />&nbsp;&nbsp;&nbsp;";		
	echo "<a class='inside' href='Includes/printable.php?id=iedrep' target='blank'><img src = 'Images/print.png'>&nbsp;Print Report</a>";
	echo "</form>";
	echo "<br />";
	echo "<font size = '5'><b>Income (Profit and Loss Account)<br />Daily Report ( " . date("d F, Y", time()) . " )</b></font>";
	echo "<table id = 'data1' width = '710px' border = '1' cellpadding = '0' cellspacing = '0'>";
		echo "<tr>";
		echo "<th rowspan='2'>TIME</th><th rowspan='2'>Item<br/>Sold</th><th rowspan='2'>Selling<br/>Price</th>";
		echo "<th colspan='2'>Profit & Loss</th><th width = '150px' rowspan='2'>Verification<br/>Code</th>";
		echo "</tr>";
		echo "<tr><th>Profit</th><th>Loss</th></tr>";
		echo "<tr><td colspan='6' valign='top'>";
			...
			$tPrice = 0; $tProfit = 0; $tLoss = 0;
				...
				echo "<tr>";
					...
					echo "<td align = 'center'>" . $row1['Verification_Method'] . " No. " . $row1['Invo_Memo_No'] . "</td>";
				echo "</tr>";
		...
		echo "<td align='right'>" . number_format($tLoss, 2, '.', ',') . "</td><td align='center'>&nbsp;</td>";
		echo "</tr>";
		echo "<tr><td colspan='6'><hr /></td></tr>";
		echo "<tr><td colspan='6' align='center'>";
		echo "Profit Remain = Total Profit - Total Loss <br />";
			$profit = $tProfit - $tLoss;
		echo "Which is = " . number_format($tProfit, 2, '.', ',') . " - " . number_format($tLoss, 2, '.', ',') . "<br />";
		echo " = " . number_format($profit, 2, '.', ',');
		echo "</td></tr>";
			if($profit > 0)
				{
		echo "<tr><td colspan='6' align='center'>The Business run Daily Transaction under the Profit of <u>" . number_format($profit, 2, '.', ',') . "</u></tr>";
				}
			else
				{
		echo "<tr><th colspan='6' align='center'><b>The Business run Daily Transaction under the Loss of <u>" . number_format(-$profit, 2, '.', ',') . "</u></b></th></tr>";		
				}
	echo "</table>";
 	echo "</center>";
	}
...
function iesdrep()
	...
	echo "</form>";
	echo "<br />";
	echo "<font size = '5'><b>Income (Profit and Loss Account)<br />Daily Report ( " . $date . " )</b></font>";
	echo "<table id = 'data1' width = '710px' border = '1' cellpadding = '0' cellspacing = '0'>";
		echo "<tr>";
		echo "<th rowspan='2'>TIME</th><th rowspan='2'>Item<br/>Sold</th><th rowspan='2'>Selling<br/>Price</th>";
		echo "<th colspan='2'>Profit & Loss</th><th width = '150px' rowspan='2'>Verification<br/>Code</th>";
...
function iemrep()
	...
	echo "Filter the Monthly Report By Month:";
		echo "<select name = 'month' required='required'>";
			echo "<option value='" . date("m", mktime()) . "'>" . date("F", time()) . "</option>";
	...
	echo "</form>";
	echo "<br />";
	echo "<font size = '5'><b>Income (Profit and Loss Account)<br/>Monthly Report ( " . date("F, Y", time()) . " )</b></font>";
	
	echo "<table id = 'data1' width = '710px' border = '1' cellpadding = '0' cellspacing = '0'>";

		echo "<tr>";
		echo "<th rowspan='2'>DATE</th><th rowspan='2'>Amount</th>";
		echo "<th colspan='2'>Profit & Loss</th>";
		echo "</tr>";
		echo "<tr><th>Profit</th><th>Loss</th></tr>";
			...
			$sProfit = $row3['sProfit'];
				...
				echo "<tr>";
					...
					echo "<td align='right'>" . number_format($row1['Amount'], 2, '.', ',') . "</td>";
						if($sProfit > 0)
							{
					echo "<td align='right'>" . number_format($sProfit, 2, '.', ',') . "</td>";
		...
		echo "<tr><th>TOTAL</th><td align='right'>" . number_format($tAmount, 2, '.', ',') . "</td>
					<td align='right'>" . number_format($tProfit, 2, '.', ',') . "</td>";
		echo "<td align='right'>" . number_format($tLoss, 2, '.', ',') . "</td>";
		echo "</tr>";
		echo "<tr><td colspan='4'><hr /></td></tr>";
		...
		echo "</td></tr>";
			if($profit > 0)
				{
		echo "<tr><td colspan='4' align='center'>The Business run Monthly Transaction under the Profit of <u>" . number_format($profit, 2, '.', ',') . "</u></tr>";
				}
			else
				{
		echo "<tr><th colspan='4' align='center'><b>The Business run Monthly Transaction under the Loss of <u>" . number_format(-$profit, 2, '.', ',') . "</u></b></th></tr>";		
				}
	echo "</table>";
 	echo "</center>";
	}
...
function iesmrep()
	...
	echo "</form>";
	echo "<br />";
	echo "<font size = '5'><b>Income(Profit and Loss Account)<br />Monthly Report ( " . $mon . ", " . $year . " )</b></font>";
...
function iearep()
	...
	echo "</form>";
	echo "<br />";
	echo "<font size = '5'><b>Income (Profit and Loss Account)<br />Annual Report ( " . date("Y", time()) . " )</b></font>";
	
	echo "<table id = 'data1' width = '710px' border = '1' cellpadding = '0' cellspacing = '0'>";
		echo "<tr>";
		echo "<th rowspan='2'>MONTH</th><th rowspan='2'>Amount</th>";
		echo "<th colspan='2'>Profit & Loss</th>";
		echo "</tr>";
		echo "<tr><th>Profit</th><th>Loss</th></tr>";
		echo "<tr>";
			...
			while($row4 = mysql_fetch_array($result4))
				...
				$sProfit = $row3['sProfit'];
					...
					echo "<td align='center'>" . $row4['Mwezi'] . "</td>";
					echo "<td align='right'>" . number_format($sAmount, 2, '.', ',') . "</td>";
						if($sProfit > 0)
							{
					echo "<td align='right'>" . number_format($sProfit, 2, '.', ',') . "</td>";
							$tProfit = $tProfit + $sProfit;
		...
		echo "</td></tr>";
			if($profit > 0)
				{
		echo "<tr><td colspan='4' align='center'>The Business run Annual Transaction under the Profit of <u>" . number_format($profit, 2, '.', ',') . "</u></tr>";
				}
			else
				{
		echo "<tr><th colspan='4' align='center'><b>The Business run Annual Transaction under the Loss of <u>" . number_format(-$profit, 2, '.', ',') . "</u></b></th></tr>";		
				}
	echo "</table>";
 	echo "</center>";
	}
...
function iesarep()
	...
	echo "</form>";
	echo "<br />";
	echo "<font size = '5'><b>Income (Profit and Loss Account)<br />Annual Report ( " . $year . " )</b></font>";
	...
	echo "<table id = 'data1' width = '710px' border = '1' cellpadding = '0' cellspacing = '0'>";
		...
		echo "<tr>";
			...
			while($row4 = mysql_fetch_array($result4))
				{			
				//Retrieve the sum of Monthly Transaction
				$query1 = "SELECT SUM(Amount) AS sAmount FROM $table_name4 
							WHERE MONTH(Date) = '$row4[0]' AND YEAR(Date) = '$year'"; 
				$result1 = mysql_query($query1);
				$row1 = mysql_fetch_array($result1);
				$sAmount = $row1['sAmount'];
				
				//Retrieve the sum of Monthly Expenditure
				$query2 = "SELECT SUM(Amount) AS sExpenditure FROM $table_name5
							WHERE MONTH(Date) = '$row4[0]' AND YEAR(Date) = '$year'"; 
				$result2 = mysql_query($query2);
				$row2 = mysql_fetch_array($result2);
				$sExpenditure = $row2['sExpenditure'];
