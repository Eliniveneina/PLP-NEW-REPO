...
<tr height="20"><td colspan="2" class="top" align="right">
	<font color="#B0D8FF">Designed by ELINIVENEINA PAUL MGUU</font>&nbsp;&nbsp;	
</td></tr>
<tr height="20"><td colspan="2" align="left">
	<table border = "0" align="center" cellspacing="0" cellpadding="0" width="100%" height="100%">
        ...
        <td align="right"><?php include('Includes/check.php'); ?>&nbsp;</td>
        </tr>
    </table>		
</td></tr>
<tr><td align="center" valign="top" width="20%">
	...
	<div class="right-div">
    	<img class="img_front" src="Images/Stationaries inline.JPG" width="710px" height="445px" />
    </div>
</td></tr>
